...
const createRequest = (input, callback) => {
  ...
  // This is where you would add method and headers      response.data.result = Requester.validateResultNumber(response.data, ['TOTAL_ENERGY', 'Value'])
  ...
  Requester.request(config, customError)
    .then(response => {
      ...
      // one another.
      if (DeviceId != null) {
        response.data.result = Requester.validateResultNumber(response.data, ['TOTAL_ENERGY', 'Value'])
      }
